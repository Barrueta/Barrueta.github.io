...
function BB8(x=0, y=0){
 ...
 this.iluminacionr = new THREE.SpotLight(0xffffff,1.7,842,0.24);
 this.iluminacionr.position.x=1;
 this.iluminacionr.position.y=1;
...
function Wall(size,x=0,y=0){
 THREE.Mesh.call(this,new THREE.BoxGeometry(size,size,size), new THREE.LambertMaterial({color:0x777777})); 
 this.size=size;
 this.position.x=x;
 this.position.y=y;
}
